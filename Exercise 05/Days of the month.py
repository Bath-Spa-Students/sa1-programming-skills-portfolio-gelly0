...
Instructions:
1. Create a Dictionary: Define a dictionary where the keys are month numbers and the values 
are the number of days in those months.
...
# Check if the number of momth is valid
if 1 <= month_num <= 12:
    print (f"Month {month_num} has {months[month_num]} days.")
else:
